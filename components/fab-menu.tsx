      ...
      <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end gap-5">
        ...
        <div className={cn(
          ...
          {menuItems.map((item, index) => (
            ...
            >
              <span className={cn(
                "px-4 py-2 rounded-xl bg-white/95 dark:bg-slate-900/95 backdrop-blur text-sm font-semibold shadow-xl border border-border/50 whitespace-nowrap transition-all duration-200 text-slate-900 dark:text-white",
